        ...
        <div id="buyNow" className="order">
            ...
            <div className="orderForm">
                ...
                <form onSubmit={ handleOrder } >
                    ...
                    <select onChange={ (e)=>{ setProduct(e.target.value)}} name="product" id="product" autoComplete="true" required>
                    ...
                    <select onChange={ (e)=>{ setQuality(e.target.value)}} name="quality" id="quality" autoComplete="true" required>
                    ...
                    <div className="note">
                        <small>The amount below is to be paid on delivery</small>
                        <h2>{`#${5700}`}</h2>
                    </div>
