...
function App() {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      fetch(
        `${process.env.REACT_APP_BACKEND_API_BASE_URL}users/${user["user"]._id}`
      )
  ...
  return (
    <div className="App">
      <Navbar
        ...
        openCloseAdminMobileNav={openCloseAdminMobileNav}
      />
      ...
      <Routes>
        ...
        <Route
          path="/:username"
          element={
            <Profile serverSuccess={serverSuccess} serverError={serverError} />
          }
        />
        <Route
